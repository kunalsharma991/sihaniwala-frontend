...
import { Wallet, Send, Upload, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto">
          {submitted ? (
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center" role="status" aria-live="polite">
              ...
              <p className="text-gray-500 mt-2">Your financial assistance application has been submitted successfully. Our team will review it and get in touch with you soon.</p>
              <div className="flex flex-wrap justify-center gap-3 mt-6">
                <button type="button" onClick={() => setSubmitted(false)} className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-2.5 rounded-xl font-semibold hover:shadow-lg transition">Submit another application</button>
